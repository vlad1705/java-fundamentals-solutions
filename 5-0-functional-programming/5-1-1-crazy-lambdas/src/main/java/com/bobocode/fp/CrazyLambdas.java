...
public class CrazyLambdas {
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        return (strIntUnaryOperatorMap, str) -> strIntUnaryOperatorMap.getOrDefault(str, IntUnaryOperator.identity());
    }
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> thenComparing(
        ...
        return (o1, o2) -> comparator.compare(o1,o2) == 0 ? comparing(mapper).compare(o1,o2) : comparator.compare(o1,o2);
    }
